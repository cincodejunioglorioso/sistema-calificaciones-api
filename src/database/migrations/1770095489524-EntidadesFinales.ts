...
export class EntidadesFinales1770095489524 implements MigrationInterface {
    name = 'EntidadesFinales1770095489524'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "periodos_lectivos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying NOT NULL, "fechaInicio" date NOT NULL, "fechaFin" date NOT NULL, "estado" "public"."periodos_lectivos_estado_enum" NOT NULL DEFAULT 'ACTIVO', "estado_supletorio" "public"."periodos_lectivos_estado_supletorio_enum" NOT NULL DEFAULT 'PENDIENTE', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5422d93ecdf01f43c4b98634e02" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "calificacion_examen" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "estudiante_id" uuid NOT NULL, "materia_curso_id" uuid NOT NULL, "trimestre_id" uuid NOT NULL, "docente_id" uuid NOT NULL, "calificacion_original" numeric(4,2), "calificacion_examen" numeric(4,2) NOT NULL, "observaciones" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f0286c63471b540536206518a14" UNIQUE ("estudiante_id", "materia_curso_id", "trimestre_id"), CONSTRAINT "PK_7edf4d9393eb7aa2ba089a8d8be" PRIMARY KEY ("id"))`);
